...
public class AvatarController {
    ...
    public List<Avatar> getAllAvatars(@RequestParam int offset, @RequestParam int page) {
        return avatarService.getAllAvatars(offset, page); // я не уверен, что так правильно :(
    }
